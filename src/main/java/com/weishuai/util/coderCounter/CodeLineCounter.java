package com.weishuai.util.coderCounter;
...
public class CodeLineCounter {
    ...
    public static void main(String[] args) {
        try {
            String projectPath = "/opt/yunding/pegasus/pegasus-java-boot";  // 替换为实际项目路径
//            String projectPath = "/opt/yunding/fire_fighting_and_security_dispatch/fire_fighting_and_security_dispatch_api";  // 替换为实际项目路径
